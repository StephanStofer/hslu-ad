 ...
 */
package ch.hslu.ad.exercises.sw11.n41.init;
...
public final class RandomInitTask extends RecursiveAction {
     ...
     */
    public RandomInitTask(final Integer[] array, final int rndBound) {
        this(array, 0, array.length, rndBound);
    }

    private RandomInitTask(final Integer[] array, final int min, final int max, final int rdBound) {
        this.array = array;
        this.min = min;
        this.max = max;
        this.rdMax = rdBound;
