 ...
 */
package ch.hslu.ad.exercises.sw07.samples.executor;

import java.util.concurrent.Executor;

import ch.hslu.ad.exercises.sw06.buffer.BoundedBufferAdapter;
...
public final class PlainWorkerPool implements Executor {
    ...
    private final BoundedBufferAdapter<Runnable> workQueue;
    ...
    public PlainWorkerPool(final int capacity, final int nWorkers) {
        this.workQueue = new BoundedBufferAdapter<>(capacity);
